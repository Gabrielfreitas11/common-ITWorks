...
exports.sendEmailOffice365NoReply = void 0;
 ...
 */
var sendEmailOffice365NoReply = function (emails, subject, html) { return __awaiter(void 0, void 0, void 0, function () {
    var transporter, from, fromName, mailOptions, info, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                from = process.env.USERNAME_NO_REPLY;
                fromName = process.env.domain === "IC" ? "Impostocerto" : "Impostograma";
                mailOptions = {
                    from: "".concat(fromName, " <").concat(from, ">"),
                    to: emails.join(", "),
                    subject: subject,
                    html: html,
                };
...
exports.sendEmailOffice365NoReply = sendEmailOffice365NoReply;
