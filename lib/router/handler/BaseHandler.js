                ...
                switch (_r.label) {
                    case 0:
                        ...
                        if ((_e = JSON.stringify(event === null || event === void 0 ? void 0 : event.headers)) === null || _e === void 0 ? void 0 : _e.toLowerCase().includes("usuario_compartilhado")) {
                            global.USUARIO_COMPARTILHADO = (_f = event.headers.USUARIO_COMPARTILHADO) !== null && _f !== void 0 ? _f : event.headers.usuario_compartilhado;
                        }
                        if ((_g = JSON.stringify(event === null || event === void 0 ? void 0 : event.headers)) === null || _g === void 0 ? void 0 : _g.toLowerCase().includes("email_login")) {
                            global.EMAIL_LOGIN = (_h = event.headers.EMAIL_LOGIN) !== null && _h !== void 0 ? _h : event.headers.email_login;
                        }
                        if ((_j = JSON.stringify(event === null || event === void 0 ? void 0 : event.headers)) === null || _j === void 0 ? void 0 : _j.toLowerCase().includes("cnpj_gestor")) {
                            global.CNPJ_GESTOR = (_k = event.headers.CNPJ_GESTOR) !== null && _k !== void 0 ? _k : event.headers.cnpj_gestor;
                        }
                        if ((_l = JSON.stringify(event === null || event === void 0 ? void 0 : event.headers)) === null || _l === void 0 ? void 0 : _l.includes("form-data")) {
                        ...
                        else if ((_m = JSON.stringify(event === null || event === void 0 ? void 0 : event.body)) === null || _m === void 0 ? void 0 : _m.includes("base64")) {
                    ...
                    case 5:
                        ...
                        if ((_o = JSON.parse(body)) === null || _o === void 0 ? void 0 : _o.custom) {
                            body = JSON.stringify((_p = JSON.parse(body)) === null || _p === void 0 ? void 0 : _p.body);
                        }
                    ...
                    case 6:
                        err_1 = _r.sent();
                        logPayload = log();
                        message = (err_1 === null || err_1 === void 0 ? void 0 : err_1.response) && ((_q = err_1 === null || err_1 === void 0 ? void 0 : err_1.response) === null || _q === void 0 ? void 0 : _q.data)
                            ? err_1.response.data
